...
async function main() {
  ...
  const devUSDC = {mint: new PublicKey("DnLM7ojzk6A8iKGNsq2NmGWy43vkBieKGefAUcd78a1U"), decimals: 6};
  const devSAMO = {mint: new PublicKey("7tNABCvkcrWuw1yPYdXBC2Xty1zedjLFHDKNQVWaAmQf"), decimals: 6};
