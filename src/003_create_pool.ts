...
const tokenAMintPubKey = new PublicKey("8wtWsdrhZxd3u18xB9aZJyqmYnbiR81jmz9CM3gUCbf8")//await createMint(provider);
const tokenBMintPubKey = new PublicKey("D7oxh2JX9LQGv9FT1a3sEFS897seiY48yF9bTQcrdqwR")
const configAccount = new PublicKey('2qMTqKpH4JZqEpw7VfCbJv5f1aDXceH6HvEpitysUfJD')
